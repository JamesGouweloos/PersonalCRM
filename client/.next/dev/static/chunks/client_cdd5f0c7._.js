...
"[project]/client/app/email-sync/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EmailSyncPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EmailSyncPage.useEffect": ()=>{
            ...
            if (errorParam) {
                ...
                checkConnectionStatus();
                setTimeout({
                    "EmailSyncPage.useEffect": ()=>setSuccess(false)
                }["EmailSyncPage.useEffect"], 5000);
            }
        }
    }["EmailSyncPage.useEffect"], [
        searchParams
    ...
    const checkConnectionStatus = async ()=>{
        try {
            setLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emailsAPI"].getStatus();
    ...
    const handleConnect = async ()=>{
        try {
            setError(null);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emailsAPI"].getAuthUrl();
    ...
    const handleSync = async ()=>{
        try {
            ...
            setError(null);
            setSyncResult(null);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emailsAPI"].sync();
    ...
    const handleDisconnect = async ()=>{
        try {
            setError(null);
            await __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emailsAPI"].disconnect();
            setConnectionStatus({
                connected: false
            });
            setSuccess(true);
...
_s(EmailSyncPage, "xl6jHD3QvCDNLlLWFgTgRwVtvT8=", false, function() {
    return [
...
_c = EmailSyncPage;
var _c;
__turbopack_context__.k.register(_c, "EmailSyncPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=client_cdd5f0c7._.js.map
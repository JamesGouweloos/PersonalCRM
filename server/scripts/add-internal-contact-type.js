/**
 * Add "Internal" to contact_type CHECK constraint
...
console.log('Adding "Internal" to contact_type CHECK constraint...');
    ...
    `, (err) => {
      ...
      db.run('DROP TABLE contacts', (err) => {
        ...
        db.run('ALTER TABLE contacts_new RENAME TO contacts', (err) => {
          ...
          console.log('✓ Contact type "Internal" added successfully!');
          process.exit(0);
        });
      });
    });

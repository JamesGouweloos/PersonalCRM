...
function transformLead(apiLead: any, contact?: Contact): Lead {
  return {
    ...
    assignedTo: apiLead.assigned_to === "James" ? "James" : (apiLead.assigned_to === "linda" ? "linda" : "me"),
    notes: apiLead.notes || undefined,
    value: apiLead.value || undefined,
    conversationId: apiLead.conversation_id || undefined,
    clientName: apiLead.client_name || undefined,

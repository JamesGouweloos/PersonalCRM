...
function InboxPage() {
    ...
    const filteredEmails = emails.filter((email)=>{
        if (searchQuery) {
            ...
            return email.subject?.toLowerCase().includes(query) || email.body?.toLowerCase().includes(query) || email.from_email?.toLowerCase().includes(query) || email.to_email?.toLowerCase().includes(query) || email.contact_name?.toLowerCase().includes(query);
        }
        return true;
    });
...
_s(InboxPage, "yQzr4dp7U3+oKGXsAjCAhz5NT2o=");
_c = InboxPage;
var _c;
...
//# sourceMappingURL=client_6b04f05f._.js.map